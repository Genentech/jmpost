#' os_prior creates a list of the required priors for the overall survival model
#' @param p Character
#' @param `1/lambda` Character
#' @param beta_os_cov Character
#' @export
...
#' long_prior creates a list of the required priors for the longitudinal model
#' @export
