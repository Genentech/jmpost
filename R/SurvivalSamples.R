...
#'
#' Utility function to extract generated quantites from a [cmdstanr::CmdStanGQ] object.
#' Multiple quantities are generated by default so this is a convience function to extract
