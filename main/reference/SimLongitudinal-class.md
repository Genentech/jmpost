...
This class exists to be extended by other classes that simulate
longitudinal data. It is not intended to be used directly.

## Usage

``` r
SimLongitudinal(times = seq(0, 100, 50))
```
