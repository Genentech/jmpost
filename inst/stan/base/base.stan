...
data{
    ...
    array[n_subjects] int<lower=1,upper=n_studies> pt_study_index;  // Index of study per pt (PT index sorted)
    array[n_subjects] int<lower=1,upper=n_arms> pt_arm_index;       // Index of treatment arm per pt (PT index sorted)
