...
For reference, the simulation functions work by sampling a cumunalative hazard limit for each subject
and then sum up the subjects exposed hazard at each time point. Subjects are then regarded
as having had an event at the timpoint in which their cumulative hazard exceeds the sampled limit.
