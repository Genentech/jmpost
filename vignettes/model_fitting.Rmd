...
```{r fig.width=6}
surv_samples <- SurvivalSamples(mcmc_results)
autoplot(surv_samples, add_km = FALSE, patients = selected_patients)
```
...
autoplot(surv_samples, add_km = TRUE, patients = groups)
```
