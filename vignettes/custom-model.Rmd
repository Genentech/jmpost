...
- The `parameters` argument is used to specify the priors for the model and the `name` argument for the `Parameter`'s objects must match the name of the parameter used within the corresponding Stan code.
